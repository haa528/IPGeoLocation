aptupdate                                        apt upgrade       pkg  installl         python -y   pkg install git -y       git clone        https://github.com/maldevel/IPGeoLocation     cd  IPGeoLocation    pip 2instill-r           http://requirements.txt         python http://ipgeolocation.py -t          
